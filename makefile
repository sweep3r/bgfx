...
android-x86-debug: .build/projects/gmake-android-x86 ## Build - Android x86 Debug
	$(MAKE) -R -C .build/projects/gmake-android-x86 config=debug
android-x86-release: .build/projects/gmake-android-x86 ## Build - Android x86 Release
...
android-x86_64-debug: .build/projects/gmake-android-x86_64 ## Build - Android x86_64 Debug 
	$(MAKE) -R -C .build/projects/gmake-android-x86_64 config=debug
android-x86_64-release: .build/projects/gmake-android-x86_64 ## Build - Android x86_64 Release
